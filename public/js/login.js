...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _indexScss = __webpack_require__(2);
  ...
  (0, _withStyles2['default'])(_indexScss2['default']);
  
  var loginInit = function loginInit() {
    (0, _jquery2['default'])(document.forms['login-form']).on('submit', function () {
      var form = (0, _jquery2['default'])(this);
  
      (0, _jquery2['default'])('.error', form).html('');
      (0, _jquery2['default'])(':submit', form).button('loading');
      ...
      _jquery2['default'].ajax({
        ...
        complete: function complete() {
          (0, _jquery2['default'])(':submit', form).button('reset');
        },
        statusCode: {
          200: function _() {
          ...
          403: function _(jqXHR) {
            ...
            (0, _jquery2['default'])('.error', form).html(error.message);
          }
        }
      });
      return false;
